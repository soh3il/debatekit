...
const WELCOME_HTML = `<b>Welcome to DebateKit</b> — the official bot for <a href="https://debatekit.ai">debatekit.ai</a>
...
Get your API key at <a href="https://debatekit.ai/chat/settings/api-keys">debatekit.ai</a>`
