/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 9c9290425ba607a01aab224ac4d0b40b)
...
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		AI: Ai;
		WEBAPP_ENV: "preview";
		APP_NAME: "DebateKit MCP (preview)";
		POSTHOG_HOST: "https://us.i.posthog.com";
		NODE_ENV: "production";
		OPENROUTER_API_KEY: string;
		BETTER_AUTH_SECRET: string;
	...
	interface Env {
		...
		APP_NAME: "DebateKit MCP" | "DebateKit MCP (preview)";
		POSTHOG_HOST: "https://us.i.posthog.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEBAPP_ENV" | "APP_NAME" | "POSTHOG_HOST" | "NODE_ENV" | "OPENROUTER_API_KEY" | "BETTER_AUTH_SECRET">> {}
}
