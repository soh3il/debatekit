...
function SvgGoogle({ ref, ...props }: SVGProps<SVGSVGElement> & { ref?: Ref<SVGSVGElement> }) {
  return (
    <svg viewBox="0 0 48 48" width="1em" height="1em" ref={ref} {...props}>
      <path
        fill="#ffc107"
...
SvgGoogle.displayName = 'GoogleIcon';
