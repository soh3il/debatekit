...
const PRESETS = [
  {
    description: 'Rigorous research analysis with adversarial challenge, methodological review, and practical grounding.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Research Analyst' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Devil\'s Advocate' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Methodology Expert' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Practitioner' },
    ],
    name: 'Research Validation Debate',
  },
  {
    description: 'Multi-perspective architecture review with security, scaling, and cost optimization analysis.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Systems Architect' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Scalability Engineer' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Security Reviewer' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Cost Optimizer' },
    ],
    name: 'Technical Architecture Debate',
  },
  {
    description: 'Adversarial investment analysis with bull/bear cases, macro context, and valuation frameworks.',
    models: [
    ...
    name: 'Investment Thesis Debate',
  },
  {
    description: 'Policy evaluation with ethical review, implementation feasibility, and stakeholder impact analysis.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Policy Analyst' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Ethics Reviewer' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Implementation Expert' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Stakeholder Advocate' },
    ],
    name: 'Policy Analysis Debate',
  },
] as const;
...
const BUILDER_MODELS = [
  { description: 'Anthropic · Advanced reasoning & analysis', enabled: true, modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, name: 'Claude Sonnet 4', provider: 'anthropic', role: 'Research Analyst' },
  { description: 'OpenAI · General-purpose intelligence', enabled: true, modelId: ModelIds.OPENAI_GPT_4_1, name: 'GPT-4.1', provider: 'openai', role: 'Devil\'s Advocate' },
  { description: 'Google · Multimodal reasoning', enabled: true, modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, name: 'Gemini 2.5 Pro', provider: 'google', role: 'Methodology Expert' },
  { description: 'xAI · Real-time knowledge', enabled: true, modelId: ModelIds.X_AI_GROK_4, name: 'Grok 4', provider: 'xai', role: 'Practitioner' },
...
export function MultiAgentDebateConfigDemo() {
