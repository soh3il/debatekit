...
const PRESETS = [
  {
    description: 'Bull/bear debate, macro analysis, and valuation framework for public equity investment decisions.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Bull Case Analyst' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Bear Case Analyst' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Macro Strategist' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Valuation Expert' },
    ],
    name: 'Public Equity Deep Dive',
  },
  {
    description: 'Startup evaluation, market sizing, technical assessment, and risk analysis for venture capital due diligence.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Market Analyst' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Tech Evaluator' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Risk Assessor' },
    ],
    name: 'VC Due Diligence',
  },
  {
    description: 'Rapid earnings call analysis, guidance interpretation, and estimate revision across portfolio holdings.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Earnings Analyst' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Guidance Tracker' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Sector Strategist' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Estimate Reviser' },
    ],
    name: 'Earnings Season Review',
  },
  {
    description: 'Portfolio-level risk assessment, correlation analysis, and stress testing across market scenarios.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Risk Manager' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Macro Analyst' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Correlation Analyst' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Stress Tester' },
    ],
...
const BUILDER_MODELS = [
  { description: 'Anthropic · Advanced reasoning & analysis', enabled: true, modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, name: 'Claude Sonnet 4', provider: 'anthropic', role: 'Bull Case Analyst' },
  { description: 'OpenAI · General-purpose intelligence', enabled: true, modelId: ModelIds.OPENAI_GPT_4_1, name: 'GPT-4.1', provider: 'openai', role: 'Bear Case Analyst' },
  { description: 'Google · Multimodal reasoning', enabled: true, modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, name: 'Gemini 2.5 Pro', provider: 'google', role: 'Macro Strategist' },
  { description: 'xAI · Real-time knowledge', enabled: true, modelId: ModelIds.X_AI_GROK_4, name: 'Grok 4', provider: 'xai', role: 'Valuation Expert' },
...
export function InvestmentConfigDemo() {
