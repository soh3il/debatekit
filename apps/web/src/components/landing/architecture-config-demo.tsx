...
const PRESETS = [
  {
    description: 'Architecture migration strategy, service boundaries, operational readiness, and team organization assessment.',
    models: [
  ...
  {
    description: 'Database selection, schema design, caching strategy, and data pipeline architecture evaluation.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Data Architect' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Query Optimizer' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Scale Engineer' },
    ],
    name: 'Data Layer Review',
  },
  {
    description: 'Cloud infrastructure review, cost optimization, reliability engineering, and disaster recovery assessment.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Cloud Architect' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'SRE Lead' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Cost Optimizer' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Security Auditor' },
    ],
    name: 'Infrastructure Audit',
  },
  {
    description: 'API design patterns, versioning strategy, backwards compatibility, and developer experience assessment.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'API Designer' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Backend Lead' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'DX Engineer' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Integration Tester' },
    ],
...
const BUILDER_MODELS = [
  ...
  { description: 'OpenAI \u00B7 General-purpose intelligence', enabled: true, modelId: ModelIds.OPENAI_GPT_4_1, name: 'GPT-4.1', provider: 'openai', role: 'Performance Engineer' },
...
export function ArchitectureConfigDemo() {
