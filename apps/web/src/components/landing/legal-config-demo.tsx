...
const PRESETS = [
  {
    description: 'Clause analysis, obligation mapping, risk scoring, and compliance check for enterprise contract review.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Contract Analyst' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Compliance Reviewer' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'IP Specialist' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Litigation Assessor' },
    ],
    name: 'Contract Review',
  },
  {
    description: 'Legal due diligence for M&A transactions — change-of-control, IP ownership, and liability analysis.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Lead Counsel' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Regulatory Analyst' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'IP Specialist' },
    ],
    name: 'M&A Legal Due Diligence',
  },
  {
    description: 'Dispute history analysis, liability exposure quantification, and enforceability assessment.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Litigation Analyst' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Risk Quantifier' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Precedent Researcher' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Settlement Advisor' },
    ],
    name: 'Litigation Risk Assessment',
  },
  {
    description: 'Regulatory alignment, policy gap analysis, and remediation planning for compliance audits.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Compliance Lead' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Policy Analyst' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Gap Assessor' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Remediation Planner' },
    ],
...
const BUILDER_MODELS = [
  { description: 'Anthropic · Advanced reasoning & analysis', enabled: true, modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, name: 'Claude Sonnet 4', provider: 'anthropic', role: 'Contract Analyst' },
  { description: 'OpenAI · General-purpose intelligence', enabled: true, modelId: ModelIds.OPENAI_GPT_4_1, name: 'GPT-4.1', provider: 'openai', role: 'Compliance Reviewer' },
  { description: 'Google · Multimodal reasoning', enabled: true, modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, name: 'Gemini 2.5 Pro', provider: 'google', role: 'IP Specialist' },
  { description: 'xAI · Real-time knowledge', enabled: true, modelId: ModelIds.X_AI_GROK_4, name: 'Grok 4', provider: 'xai', role: 'Litigation Assessor' },
...
export function LegalConfigDemo() {
