...
const PRESETS = [
  {
    description: 'Systems design, security assessment, performance analysis, and operational readiness for architecture decisions.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Systems Architect' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Performance Engineer' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Security Reviewer' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Pragmatist' },
    ],
    name: 'Architecture Review Council',
  },
  {
    description: 'Business analysis, risk assessment, innovation evaluation, and operational impact for strategic decisions.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Business Analyst' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Risk Assessor' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Innovation Lead' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Operations Expert' },
    ],
    name: 'Strategic Decision Council',
  },
  {
    description: 'Senior engineering review, security auditing, performance analysis, and API design evaluation.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Senior Engineer' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Security Auditor' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Performance Specialist' },
    ],
    name: 'Code Review Council',
  },
  {
    description: 'Product strategy, user research, technical feasibility, and data-driven decision making.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Product Manager' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'UX Researcher' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Tech Lead' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Data Analyst' },
    ],
    name: 'Product Decision Council',
  },
] as const;
...
const BUILDER_MODELS = [
  { description: 'Anthropic · Advanced reasoning & analysis', enabled: true, modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, name: 'Claude Sonnet 4', provider: 'anthropic', role: 'Systems Architect' },
  { description: 'OpenAI · General-purpose intelligence', enabled: true, modelId: ModelIds.OPENAI_GPT_4_1, name: 'GPT-4.1', provider: 'openai', role: 'Scalability Engineer' },
  ...
  { description: 'xAI · Real-time knowledge', enabled: true, modelId: ModelIds.X_AI_GROK_4, name: 'Grok 4', provider: 'xai', role: 'Pragmatist' },
...
export function LlmCouncilConfigDemo() {
