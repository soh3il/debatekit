...
const PRESETS = [
  {
    description: 'Evaluate impact of new or amended regulations on your organization',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Regulatory Monitor' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Gap Analyst' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Risk Prioritizer' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Advisory Drafter' },
    ],
    name: 'Regulatory Change Assessment',
  },
  {
    description: 'Comprehensive audit of compliance posture across all applicable frameworks',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Regulatory Monitor' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Gap Analyst' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Risk Prioritizer' },
  ...
  {
    description: 'Quantitative risk scoring across regulatory domains with prioritized remediation',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Regulatory Monitor' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Gap Analyst' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Risk Prioritizer' },
  ...
  {
    description: 'Navigate multi-jurisdictional regulatory requirements for global operations',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Regulatory Monitor' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Gap Analyst' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Risk Prioritizer' },
    ...
    name: 'Cross-Border Compliance Review',
  },
] as const;
...
const BUILDER_MODELS = [
  { description: 'Anthropic · Advanced reasoning & analysis', enabled: true, modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, name: 'Claude Sonnet 4', provider: 'anthropic', role: 'Regulatory Monitor' },
  { description: 'OpenAI · General-purpose intelligence', enabled: true, modelId: ModelIds.OPENAI_GPT_4_1, name: 'GPT-4.1', provider: 'openai', role: 'Gap Analyst' },
  { description: 'Google · Multimodal reasoning', enabled: true, modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, name: 'Gemini 2.5 Pro', provider: 'google', role: 'Risk Prioritizer' },
  { description: 'xAI · Real-time knowledge', enabled: true, modelId: ModelIds.X_AI_GROK_4, name: 'Grok 4', provider: 'xai', role: 'Advisory Drafter' },
...
export function ComplianceConfigDemo() {
