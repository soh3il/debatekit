...
const PRESETS = [
  {
    description: 'Financial analysis, legal risk assessment, strategic fit evaluation, and risk scoring for M&A deal screening.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Financial Analyst' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Legal Counsel' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Strategic Advisor' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Risk Assessor' },
    ],
    name: 'M&A Advisory',
  },
  {
  ...
  {
    description: 'Long-term positioning, competitive moat assessment, growth planning, and synthesis across strategic dimensions.',
    models: [
      { modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, provider: 'anthropic', role: 'Strategist' },
      { modelId: ModelIds.OPENAI_GPT_4_1, provider: 'openai', role: 'Analyst' },
      { modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, provider: 'google', role: 'Challenger' },
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Synthesizer' },
    ],
    name: 'Strategic Planning',
  },
  {
    description: 'Contract review, regulatory compliance, IP exposure, and liability assessment across legal domains.',
    models: [
      ...
      { modelId: ModelIds.X_AI_GROK_4, provider: 'xai', role: 'Liability Assessor' },
    ],
    name: 'Legal Analysis',
  },
] as const;
...
const BUILDER_MODELS = [
  { description: 'Anthropic · Advanced reasoning & analysis', enabled: true, modelId: ModelIds.ANTHROPIC_CLAUDE_SONNET_4, name: 'Claude Sonnet 4', provider: 'anthropic', role: 'Financial Analyst' },
  { description: 'OpenAI · General-purpose intelligence', enabled: true, modelId: ModelIds.OPENAI_GPT_4_1, name: 'GPT-4.1', provider: 'openai', role: 'Legal Counsel' },
  { description: 'Google · Multimodal reasoning', enabled: true, modelId: ModelIds.GOOGLE_GEMINI_2_5_PRO, name: 'Gemini 2.5 Pro', provider: 'google', role: 'Strategic Advisor' },
  { description: 'xAI · Real-time knowledge', enabled: true, modelId: ModelIds.X_AI_GROK_4, name: 'Grok 4', provider: 'xai', role: 'Risk Assessor' },
